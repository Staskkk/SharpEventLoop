namespace SharpEventLoop
{
    public interface IAsyncEvent
    {
        ...
        IAsyncEvent Then<TResult>(Func<TResult?> eventHandler, long delay = 0, CancellationToken? cancellationToken = null);
        ...
        IAsyncEvent Then<TParam, TResult>(Func<TParam?, TResult?> eventHandler, long delay = 0, CancellationToken? cancellationToken = null);
